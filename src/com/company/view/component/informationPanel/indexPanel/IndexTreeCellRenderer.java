...
public class IndexTreeCellRenderer implements TreeCellRenderer {
    ...
    public IndexTreeCellRenderer (){
        ...
        nonLeafRenderer.setLeafIcon(Utils.createIcon("/com/company/img/Server16.gif"));
        nonLeafRenderer.setOpenIcon(Utils.createIcon("/com/company/img/WebComponent16.gif"));
        nonLeafRenderer.setClosedIcon(Utils.createIcon("/com/company/img/WebComponentAdd16.gif"));
